...
public class AppointmentBetaActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appointment_beta);
    ...
    private void clickImageButton() {
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getBaseContext(), PopUpAppDoctorActivity.class);
    ...
    private void showListView() {
        ...
        if (!stringsAppointment[0][0].equals("")) {
            ...
            MyAdaptorAppointment myAdaptorAppointment = new MyAdaptorAppointment(AppointmentBetaActivity.this,
            ...
            public void onClick(View v) {
                ...
                if (sSkip.equals("N") && stringTime.equals("")) {
                    ...
                    if (stringDoctor.equals("") || stringDate.equals("")) {
                        ...
                        //ทำไปต่อจากตรงนี้
                        MyManage myManage = new MyManage(AppointmentBetaActivity.this);
                        MyData myData = new MyData();
